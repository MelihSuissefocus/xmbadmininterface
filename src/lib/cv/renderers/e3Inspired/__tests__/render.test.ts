...
const candidateFull: CVData = {
  ...
  skills: [
    { category: "Backend", details: "Java" },
    { category: "Backend", details: "Spring Boot" },
    { category: "DevOps", details: "Kubernetes" },
    { category: "Cloud", details: "AWS" },
    { category: "DevOps", details: "Terraform" },
    { category: "DevOps", details: "CI/CD" },
    { category: "Backend", details: "PostgreSQL" },
    { category: "DevOps", details: "Docker" },
    { category: "Frontend", details: "React" },
    { category: "Frontend", details: "TypeScript" },
  ],
  highlights: [
