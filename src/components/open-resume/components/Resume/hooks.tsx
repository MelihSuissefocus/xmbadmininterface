...
import { A4_HEIGHT_PX, LETTER_HEIGHT_PX } from "@/components/open-resume/lib/constants";
import { getPxPerRem } from "@/components/open-resume/lib/get-px-per-rem";
import { CSS_VARIABLES } from "@/components/open-resume/globals-css";
