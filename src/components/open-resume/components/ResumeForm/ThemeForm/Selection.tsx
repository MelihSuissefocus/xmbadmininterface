import type { GeneralSetting } from "@/components/open-resume/lib/redux/settingsSlice";
import { PX_PER_PT } from "@/components/open-resume/lib/constants";
import {
  FONT_FAMILY_TO_STANDARD_SIZE_IN_PT,
  FONT_FAMILY_TO_DISPLAY_NAME,
  type FontFamily,
} from "@/components/open-resume/components/fonts/constants";
import { getAllFontFamiliesToLoad } from "@/components/open-resume/components/fonts/lib";
