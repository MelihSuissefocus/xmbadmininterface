import { BULLET_POINTS } from "@/components/open-resume/lib/parse-resume-from-pdf/extract-resume-from-sections/lib/bullet-points";
import { isBold } from "@/components/open-resume/lib/parse-resume-from-pdf/extract-resume-from-sections/lib/common-features";
import type { Lines, Line, Subsections } from "@/components/open-resume/lib/parse-resume-from-pdf/types";
