import type { ResumeWorkExperience } from "@/components/open-resume/lib/redux/types";
import type {
  TextItem,
  FeatureSet,
  ResumeSectionToLines,
} from "@/components/open-resume/lib/parse-resume-from-pdf/types";
import { getSectionLinesByKeywords } from "@/components/open-resume/lib/parse-resume-from-pdf/extract-resume-from-sections/lib/get-section-lines";
import {
  DATE_FEATURE_SETS,
  hasNumber,
  getHasText,
  isBold,
} from "@/components/open-resume/lib/parse-resume-from-pdf/extract-resume-from-sections/lib/common-features";
import { divideSectionIntoSubsections } from "@/components/open-resume/lib/parse-resume-from-pdf/extract-resume-from-sections/lib/subsections";
import { getTextWithHighestFeatureScore } from "@/components/open-resume/lib/parse-resume-from-pdf/extract-resume-from-sections/lib/feature-scoring-system";
import {
  getBulletPointsFromLines,
  getDescriptionsLineIdx,
} from "@/components/open-resume/lib/parse-resume-from-pdf/extract-resume-from-sections/lib/bullet-points";
