import {
  ...
  matchPhone,
  matchUrl,
} from "@/components/open-resume/lib/parse-resume-from-pdf/extract-resume-from-sections/extract-profile";
import type { TextItem } from "@/components/open-resume/lib/parse-resume-from-pdf/types";
