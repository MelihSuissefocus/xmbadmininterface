...
import type { RootState } from "@/components/open-resume/lib/redux/store";
import type {
  FeaturedSkill,
  Resume,
  ResumeEducation,
...
} from "@/components/open-resume/lib/redux/types";
import type { ShowForm } from "@/components/open-resume/lib/redux/settingsSlice";
